...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        console.log('📝 Registration Request:', { name, email, phone, role, passwordLength: password?.length });
...
const authUser = async (req, res) => {
    ...
    try {
        ...
        console.log('🔐 Login Request Body:', { email, password: password ? '***' + password.slice(-3) : 'MISSING' });
        ...
        if (user && (await user.matchPassword(password))) {
            ...
            console.log('❌ Login failed for:', email, '- Reason:', !user ? 'User not found' : 'Password mismatch');
